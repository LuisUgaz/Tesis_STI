...
- **Gestión de Videos Recomendados (HU33):** Módulo de administración de recursos multimedia que permite a los docentes registrar enlaces externos de YouTube vinculados a temas específicos. El sistema automatiza la extracción de miniaturas de alta calidad y centraliza el contenido en una interfaz moderna de "Gestión de Contenidos", integrándolos fluidamente en las recomendaciones personalizadas del estudiante para reforzar su aprendizaje teórico-práctico.
