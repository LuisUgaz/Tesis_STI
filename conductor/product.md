...
- **Consultar Historial de Resultados (HU18 y HU19):** Interfaz dedicada accesible desde el perfil del estudiante que permite visualizar de forma organizada y cronolÃ³gica todas las actividades realizadas. Incluye capacidades de filtrado avanzado por tema y rangos de fechas con selectores interactivos, permitiendo un seguimiento preciso de la evoluciÃ³n acadÃ©mica y facilitando la metacogniciÃ³n.
- **CÃ¡lculo de MÃ©tricas AcadÃ©micas (HU20):** Motor de procesamiento estadÃ­stico que recalcula automÃ¡ticamente indicadores de desempeÃ±o (precisiÃ³n general, rendimiento acumulado, tiempo promedio de respuesta y dominio por tema) tras cada interacciÃ³n, persistiendo los datos en un modelo independiente para optimizar la adaptabilidad y el monitoreo acadÃ©mico.
- **Panel de VisualizaciÃ³n de DesempeÃ±o (HU21):** Interfaz dedicada ("Mi progreso") accesible desde el menÃº principal que traduce las mÃ©tricas calculadas en un dashboard visual amigable. Utiliza tarjetas de resumen, barras de progreso por temas y elementos gamificados para que el estudiante comprenda su nivel de dominio y evoluciÃ³n en tiempo real.
- **AsignaciÃ³n de Puntos por Actividad (HU22):** NÃºcleo del sistema de gamificaciÃ³n que otorga puntos de experiencia (XP) por cada interacciÃ³n educativa validada. Incluye una regla centralizada de puntos segÃºn dificultad de ejercicios (10-30 pts) e interacciones con contenido (5 pts), con feedback visual inmediato (Toasts y animaciones) y persistencia atÃ³mica en el perfil del estudiante.
- **Subida de Nivel (HU23):** Motor de progresiÃ³n que incrementa el nivel del estudiante automÃ¡ticamente cada 100 puntos XP acumulados. Gestiona la persistencia en el modelo Profile y notifica el logro mediante un feedback visual especial (Toast dorado) y actualizaciones animadas en la interfaz de usuario.
- **AsignaciÃ³n AutomÃ¡tica de Insignias (HU24):** Sistema de logros que evalÃºa el progreso acadÃ©mico bajo reglas de hitos, dominio y progresiÃ³n. Otorga insignias persistentes (modelos dedicados), muestra notificaciones asÃ­ncronas (Toasts) y presenta una galerÃ­a visual en el perfil del estudiante para incentivar el compromiso.
- **VisualizaciÃ³n Detallada de Insignias (HU25):** Interfaz interactiva de colecciÃ³n de logros que permite al estudiante explorar su historial de Ã©xitos. Implementa una galerÃ­a con efectos visuales de estado (color vs escala de grises), ordenamiento por relevancia y un sistema de modales que detalla la descripciÃ³n y la fecha exacta de obtenciÃ³n de cada insignia.
- **Reportes de Progreso para Docentes (HU26):** MÃ³dulo analÃ­tico avanzado exclusivo para docentes que centraliza el monitoreo del aula. Incluye un dashboard con mÃ©tricas agregadas (precisiÃ³n, XP promedio), grÃ¡ficos interactivos de dominio por tema (radar charts) y un listado detallado de estudiantes con filtros por grado, secciÃ³n y nombre.
- **Filtrado Avanzado de Reportes (HU27):** EvoluciÃ³n interactiva del dashboard docente que permite un anÃ¡lisis granular mediante filtros por rangos de fechas y temas especÃ­ficos. Implementa actualizaciones asÃ­ncronas (AJAX) que refrescan grÃ¡ficos y tablas instantÃ¡neamente sin recargar la pÃ¡gina, optimizando la toma de decisiones pedagÃ³gicas.
- **Registro de Preguntas en Banco (HU29):** Módulo de gestión de contenido exclusivo para docentes que permite registrar nuevos ejercicios geométricos sin acceder al administrador de Django. Incluye un formulario interactivo para capturar el enunciado, tema, dificultad, explicación técnica y exactamente 5 opciones de respuesta, asegurando la integridad pedagógica mediante validaciones integradas y persistencia transaccional.
- **Gestión y Edición de Preguntas (HU30):** Ampliación del banco de problemas que otorga al docente una interfaz dedicada para listar todos los ejercicios existentes. Permite la actualización integral de cualquier pregunta registrada, incluyendo la modificación de textos, cambio de niveles de dificultad y ajuste de opciones correctas, garantizando que el material de práctica se mantenga vigente y preciso sin comprometer la integridad de los resultados históricos.
- **Eliminación Lógica de Ejercicios (HU31):** Mecanismo de retiro seguro de contenido que permite a los docentes desactivar preguntas obsoletas o erróneas. Implementa una estrategia de "Soft Delete" que oculta las preguntas de futuras sesiones de práctica y del listado de gestión, pero preserva los registros en la base de datos para mantener la validez de las métricas y el historial académico de los estudiantes que ya las resolvieron.
- **Clasificación Estándar por Tema y Nivel (HU32):** Formalización de la estructura de datos académica en todo el sistema. Unifica la categorización de ejercicios y preguntas del examen diagnóstico mediante una relación estricta con el modelo Tema y una escala de dificultad normalizada (Básico, Intermedio, Avanzado). Implementa filtros avanzados en el listado docente para una organización eficiente y prepara la infraestructura para la selección adaptativa inteligente.
- **Gestión de Videos Recomendados (HU33 y HU34):** Módulo de administración de recursos multimedia que permite a los docentes registrar enlaces externos de YouTube y eliminar videos obsoletos del catálogo mediante borrado lógico ("Soft Delete"). El sistema automatiza la extracción de miniaturas, centraliza el contenido en una interfaz moderna de "Gestión de Contenidos" y preserva la integridad de los registros históricos de visualización de los estudiantes.
- **Consultas al Docente vía Email (HU35):** Funcionalidad de comunicación directa que permite a los estudiantes enviar dudas desde un formulario accesible en la barra de navegación. El sistema automatiza el envío de correos electrónicos al docente (luisugaz63@gmail.com) incluyendo el nombre del estudiante, el mensaje y el contexto opcional (ID del tema o ejercicio actual), facilitando la resolución de dudas externas sin almacenamiento persistente en el sistema.
- **Gestión Centralizada de Usuarios (HU36):** Módulo administrativo avanzado que otorga a los administradores control total sobre las cuentas del sistema. Permite listar usuarios con filtros dinámicos (rol, grado, estado), crear nuevas cuentas con asignación de roles, editar información académica y personal, y realizar activaciones o desactivaciones rápidas mediante un panel interactivo con AJAX, garantizando la seguridad y vigencia del acceso a la plataforma.
- **Gestión de Exámenes por Tema (HU39):** Funcionalidad de evaluación continua que permite a los docentes crear exámenes personalizados para cada tema de geometría. El sistema automatiza la asignación aleatoria de preguntas disponibles del banco de preguntas, valida la disponibilidad de materiales y permite la liberación automática de recursos al eliminar un examen, proporcionando datos precisos para el ajuste adaptativo de la dificultad.
- **Retroalimentación Inteligente Multimodal (HU40):** Sistema de tutoría basado en IA que utiliza Gemini 1.5 Flash para proporcionar explicaciones pedagógicas personalizadas tras el examen diagnóstico. El sistema analiza tanto el texto como las imágenes de las preguntas para explicar por qué una respuesta es correcta o identificar el error lógico del estudiante, cargando estas explicaciones de forma asíncrona para no interrumpir la visualización inmediata de los resultados.
- **Motor de Recomendación Adaptativo Avanzado (HU42):** Evolución del núcleo inteligente del sistema que ahora utiliza un **Puntaje de Desempeño Ponderado (PDP)** para identificar debilidades. Este motor integra variables multidimensionales como la dificultad de las preguntas y el tiempo de respuesta normalizado. Además, implementa un **clasificador SVM (Support Vector Machine)** para resolver de forma inteligente los empates técnicos entre temas, basándose en el perfil histórico del estudiante, asegurando una ruta de aprendizaje hiper-personalizada.
- **Alertas Tempranas de Riesgo de Aprendizaje (HU46):** Sistema de monitoreo proactivo que analiza patrones de comportamiento (adivinanza, frustración y estancamiento) basándose en umbrales de tiempo y reintentos. Integra un indicador visual tipo semáforo en los reportes docentes con tooltips descriptivos, permitiendo a los profesores identificar dificultades no evidentes en la nota final y actuar preventivamente.
- **Repetición Espaciada Automática (HU47):** Algoritmo inteligente que programa repasos de temas dominados basándose en la curva del olvido. Utiliza una adaptación del algoritmo SM-2 para calcular intervalos crecientes tras aciertos y penalizaciones tras fallos, priorizando temas vencidos en el motor de recomendación para garantizar la retención a largo plazo.
- **Generación Automática de Gráficos Geométricos (HU48):** Innovadora funcionalidad que automatiza la creación de figuras visuales para preguntas importadas sin imagen. Utiliza IA (Google Gemini) para traducir enunciados textuales en código Matplotlib, el cual se ejecuta en un entorno seguro para producir archivos SVG vinculados automáticamente a los ejercicios, reduciendo drásticamente la carga de trabajo manual del docente.
