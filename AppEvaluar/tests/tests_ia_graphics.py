...
from AppEvaluar.services_ia_graphics import validar_codigo_seguro, generar_codigo_grafico, ejecutar_grafico_y_guardar, procesar_imagen_automatica
...
class IAGraphicsTest(TestCase):
    ...
    def test_procesar_imagen_automatica_retry(self, mock_generar):
        ...
        from AppEvaluar.services_ia_graphics import procesar_imagen_automatica
