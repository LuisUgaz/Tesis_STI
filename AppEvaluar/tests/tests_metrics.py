...
from AppEvaluar.models import Ejercicio, ResultadoEjercicio, ExamenDiagnostico, ResultadoDiagnostico
from AppTutoria.models import Tema
from AppEvaluar.services_metrics import actualizar_metricas_estudiante
...
class MetricsServiceTest(TestCase):
    def setUp(self):
        ...
        from AppEvaluar.models import OpcionEjercicio
