...
from AppEvaluar.models import ExamenDiagnostico, Pregunta, Opcion, RespuestaUsuario, RecomendacionEstudiante, ResultadoDiagnostico
...
class AdaptiveLogicTest(TestCase):
    ...
    def test_svm_dynamic_learning(self):
        ...
        """
        from AppEvaluar.models import LogEntrenamientoSVM
        ...
        from AppEvaluar.services import evaluar_exito_recomendacion
